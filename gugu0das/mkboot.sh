...
cd $dir
mv Cyanogenmod_14.1/boot_hltekor.img gugu0das_kernel-NX_CM-14.1-hltekor-Release-1/boot.img

mv Cyanogenmod_14.1/boot_hlteeur.img gugu0das_kernel-NX_CM-14.1-hlteeur-Release-1/boot.img

# Compression
cd $dir/gugu0das_kernel-NX_CM-14.1-hltekor-Release-1
zip -r gugu0das_kernel-NX_CM-14.1-hltekor-Release-1.zip ./*
...
cd $dir/gugu0das_kernel-NX_CM-14.1-hltekor-Release-1
mv gugu0das_kernel-NX_CM-14.1-hltekor-Release-1.zip $kernel_dir/gugu0das_kernel-NX_CM-14.1-hltekor-Release-1.zip
