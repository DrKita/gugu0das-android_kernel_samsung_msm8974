...
cd $dir
mv Cyanogenmod_13.0/boot.img gugu0das_kernel-CM-13.0-ks01ltekor-Release-2/boot.img

# Compression
cd $dir/gugu0das_kernel-CM-13.0-ks01ltekor-Release-2
zip -r gugu0das_kernel-CM-13.0-ks01ltekor-Release-2.zip ./*

# Move Kernel Flashing File
cd $dir/gugu0das_kernel-CM-13.0-ks01ltekor-Release-2
mv gugu0das_kernel-CM-13.0-ks01ltekor-Release-2.zip $kernel_dir/gugu0das_kernel-CM-13.0-ks01ltekor-Release-2.zip
