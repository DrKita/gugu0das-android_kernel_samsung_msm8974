...
rm -f gugu0das/gugu0das_kernel-NX_CM-13.0-hltekor-Release-1/boot.img
rm -f gugu0das/gugu0das_kernel-NX_TW-M-hltekor-Release-1/boot.img
rm -f gugu0das_kernel-NX_CM-13.0-hltekor-Release-1.zip
rm -f gugu0das_kernel-NX_TW-M-hltekor-Release-1.zip
