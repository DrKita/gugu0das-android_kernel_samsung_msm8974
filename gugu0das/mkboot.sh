...
# Touchwiz hlteskt Value
echo "Generating Touchwiz hlteskt Boot Image"
./mkbootimg --kernel "$dir/Touchwiz/kernel_hlteskt" \
--ramdisk "$dir/Touchwiz/ramdisk.cpio.gz" \
--dt "$dir/Touchwiz/dt_hlteskt.img" \
...
--output $dir/Touchwiz/boot_hlteskt.img
cd $dir/Touchwiz
...
# Cyanogenmod_13.0/LineageOS_13.0 hlteskt Value
echo "Generating Cyanogenmod_13.0 hlteskt Boot Image"
./mkbootimg --kernel "$dir/Cyanogenmod_13.0/kernel_hlteskt" \
--ramdisk "$dir/Cyanogenmod_13.0/ramdisk.cpio.gz" \
--dt "$dir/Cyanogenmod_13.0/dt_hlteskt.img" \
--cmdline "console=null androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x3F androidboot.bootdevice=msm_sdcc.1 androidboot.selinux=permissive" \
--base 0x00000000 \
--pagesize 2048 \
--ramdisk_offset 0x02000000 \
--tags_offset 0x01e00000 \
--output $dir/Cyanogenmod_13.0/boot_hlteskt.img
...
cd $dir
mv Cyanogenmod_13.0/boot_hlteskt.img gugu0das_kernel-NX_CM-13.0-hlteskt-Release-1/boot.img
mv Touchwiz/boot_hlteskt.img gugu0das_kernel-NX_TW-M-hlteskt-Release-1/boot.img
...
# Compression
cd $dir/gugu0das_kernel-NX_CM-13.0-hlteskt-Release-1
zip -r gugu0das_kernel-NX_CM-13.0-hlteskt-Release-1.zip ./*
cd $dir/gugu0das_kernel-NX_TW-M-hlteskt-Release-1
zip -r gugu0das_kernel-NX_TW-M-hlteskt-Release-1.zip ./*
...
cd $dir/gugu0das_kernel-NX_CM-13.0-hlteskt-Release-1
mv gugu0das_kernel-NX_CM-13.0-hlteskt-Release-1.zip $kernel_dir/gugu0das_kernel-NX_CM-13.0-hlteskt-Release-1.zip
cd $dir/gugu0das_kernel-NX_TW-M-hlteskt-Release-1
mv gugu0das_kernel-NX_TW-M-hlteskt-Release-1.zip $kernel_dir/gugu0das_kernel-NX_TW-M-hlteskt-Release-1.zip
